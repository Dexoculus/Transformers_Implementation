...
from Transformers.transformer import FeedForwardBlock
from Transformers.reversible import ReversibleSequence, SequentialSequence
...
class Linformer(nn.Module):
    def __init__(self, dim, seq_len, depth, k = 256, heads = 8, dim_head = None, one_kv_head = False, share_kv = False, reversible = False, dropout = 0.):
        ...
        for _ in range(depth):
            ...
            ff = FeedForwardBlock(dim, dropout = dropout)
